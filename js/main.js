(function (window, document, undefined) {
    ...
    var Ray = function () {
        ...
        this.angle = 100 * Math.PI / 180; //105 deg in radians
        ...
        this.color = function () {
            ...
            var alpha = wave(this.life, this.ttl) * 0.005, //fade in/fade out alpha
                ...
                color2 = "hsla(0,10%,10%,0)", //bottom color of ray gradient (transparent)
    ...
    var Particle = function () {
        ...
        this.init = function () {
            this.position = {
                //random x,y position
                x: Math.random() * width,
                y: height / 4 + Math.random() * height / 1
            };
            this.velocity = {
    ...
    function render(c1, c2) {
        ...
        c2.shadowBlur = 50; //add a 'glow' to rays/particles
        c2.shadowColor = "#0077be";
